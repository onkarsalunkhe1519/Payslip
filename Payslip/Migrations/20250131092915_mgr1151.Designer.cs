...
namespace Payslip.Migrations
{
    ...
    [Migration("20250131092915_mgr1151")]
    partial class mgr1151
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Payslip.Models.EmployeeSalaries", b =>
                {
                    ...
                    b.Property<int>("DeductionsDeductionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeductionsDeductionId");
            ...
            modelBuilder.Entity("Payslip.Models.EmployeeSalaries", b =>
                {
                    b.HasOne("Payslip.Models.Deduction", "Deductions")
                        .WithMany()
                        .HasForeignKey("DeductionsDeductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
